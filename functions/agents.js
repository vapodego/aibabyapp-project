/**
 * =================================================================
 * AIエージェント連携によるDeep Research実装コード (v38.7 安定性向上版)
 * =================================================================
 * 主な改善点:
 * 1. 【バグ修正】Firebaseエミュレータのホットリロード時に発生する二重初期化エラーを、
 * try...catchブロックを使用してより確実に防止するように修正しました。
 */
...
// ★★★ 修正点 ★★★
// Firebase Admin SDKを安全に初期化します。
// エミュレータのホットリロード時に発生する二重初期化エラーを防止するため、
// 既に初期化されている場合はエラーをキャッチして無視します。
try {
  admin.initializeApp();
} catch (e) {
